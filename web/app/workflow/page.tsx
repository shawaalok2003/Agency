            ...
            <main className="pt-48 pb-24">
                ...
                <div className="max-w-4xl mx-auto px-6 text-center mb-16">
                    ...
                    <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
                        Stop juggling tools. From the first handshake to the final invoice, AgencyOS orchestrates your entire operation in a single unified workspace.
                    </p>
                </div>
                    ...
                    <section className="scroll-mt-40" id="deliverables">
                        <div className="glass-card rounded-xl p-8 lg:p-12 flex flex-col lg:flex-row-reverse gap-12 items-center relative overflow-hidden bg-[#0a0f1e]">
                            ...
                            <div className="flex-1 space-y-6 relative z-10">
                                ...
                                <p className="text-slate-400 text-lg leading-relaxed">
                                    Stop manual task creation. When a contract is signed, AgencyOS automatically builds the project structure, assigns leads, and sets deadlines.
                                </p>
                                <ul className="space-y-4 pt-4">
                                    {[
                ...
                <div className="mt-32 max-w-5xl mx-auto px-6">
                    <div className="bg-[#5048e5] rounded-3xl p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl shadow-[#5048e5]/30">
                        ...
                        <p className="mt-8 text-white/70 text-sm font-medium relative z-10">Join 1,200+ top-tier agencies already scaling on AgencyOS.</p>
                    </div>
                </div>
            </main>
            ...
            <footer className="border-t border-slate-200 dark:border-slate-800 py-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-slate-800 dark:text-white">AgencyOS</span>
                    </div>
                    ...
                    <p className="text-sm text-slate-500">© 2024 AgencyOS Inc. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );
